...
public class PageServiceImpl implements PageService {
    ...
    private String buildChildrenList(Page page, Language language) {
        ...
        for (Page childPage : childPages) {
            builder.append("<div class=\"child-reference child-reference-list\">")
                    ...
                    .append(String.format("<h3 \"color:tomato\">%s</h3>", childPage.getTitle(language)))
                    .append(String.format("<p  style=\"color:blue\">%s</p>", childPage.getDesctiption(language)))
                    .append(String.format("<a class=\"custom-a\" href=\"%s\">%s</a>", childPage.getCode(language), StaticFieldsUtils.getOpenTextShortened()))
                    .append("</div>");
        }
        builder.append("</div>");
    ...
    private String buildIndexPageHeader(String parentCode, Language language) {
        String template = "<h2 class=\"mb-4\" style=\"color:tomato\">%s</h2>";
    ...
    private String buildTableCell(String text) {
        return String.format("<td class=\"text-center\"><span style=\"color:tomato\">%s</span></td>", text);
    }

    private String buildTableHeaderCell(String text) {
        return String.format("<th class=\"text-center\" style=\"color:DodgerBlue\">%s</th>", text);
    }
